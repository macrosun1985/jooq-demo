...
public class BookToBookStore extends TableImpl<BookToBookStoreRecord> {
    ...
    private static final long serialVersionUID = -245382328;
     ...
     */
    public final TableField<BookToBookStoreRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR.length(50).nullable(false), this, "");
